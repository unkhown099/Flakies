...
body {
    ...
    line-height:1.6; color:#fff; background-color: #f4e04d; overflow-x:hidden;
}
.navbar-custom { background-color: #2d2d2d; }
...
.card.selected { background-color: #28a745 !important; }
...
table { background-color: #fff; border-radius:12px; overflow:hidden; box-shadow:0 4px 6px rgba(0,0,0,0.1); color:#000; }
thead { background-color: #343a40; color:#fff; }
td, th { vertical-align: middle !important; }

.cart-summary { color: black; } /* Make total/items text black */
