    ...
    <style>
        ...
        * {
        ...
        .card {
            ...
            transition: 0.3s;
            background: #fff;
            /* Card background white for readability */
            color: #333;
        }
...
<body>
    ...
    <!-- Navbar -->
    <nav>
        <a href="#" class="logo"><img src="../assets/pictures/45b0e7c9-8bc1-4ef3-bac2-cfc07174d613.png" alt="Logo"><span>Flakies POS</span></a>
        <ul class="nav-links">
